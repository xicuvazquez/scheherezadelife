...
const product = {
  ...
  description:
    "Pulsera de plata 925 con pequeños acentos de esmalte en color. Una pieza ligera, luminosa y delicada, pensada para llevar sola y aportar un gesto sutil de color.",
 ...
 details: [
    "Bolas de plata",
    "Bolas de esmalte en rosa, turquesa, amarillo, lila y verde",
    "Medida: 18 cm",
    "Alargador: 3 cm",
  ],

  editorial: "/images/products/pulsera-arcoiris-editorial.png",

  worn: "/images/products/pulsera-arcoiris-worn.png",
};

export default function PulseraArcoirisPage() {
    ...
    <main className="bg-[#f5f1eb] min-h-screen text-black">
      ...
      <section className="max-w-[1600px] mx-auto px-8 md:px-14 pt-14 pb-32">
        ...
        <div className="flex items-center gap-3 text-[11px] uppercase tracking-[0.22em] opacity-45 mb-10">
          ...
          <span className="opacity-80">Pulsera Arcoíris</span>
        </div>
