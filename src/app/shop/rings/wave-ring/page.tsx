...
const product = {
  ...
  description:
    "Anillo de plata seleccionado por su forma fluida, su línea abierta y su presencia ligera sobre la mano.",
...
export default function WaveRingPage() {
    ...
    <main className="bg-[#f5f1eb] min-h-screen text-black">
      ...
      <section className="max-w-[1600px] mx-auto px-8 md:px-14 pt-14 pb-32">
        ...
        <div className="flex items-center gap-3 text-[11px] uppercase tracking-[0.22em] opacity-45 mb-10">
          ...
          <span className="opacity-80">Wave Ring</span>
        </div>
